    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (var myActorSystem = ActorSystem.Create("MyActorSystem"))
            {
                ...
                IActorRef consoleWriterActor = myActorSystem.ActorOf(consoleWriterProps, "L4_Writer");
                ...
                IActorRef consoleReaderActor = myActorSystem.ActorOf(consoleReaderProps, "L4_Reader");
